...
@Component({
  selector: 'app-encherdetails',
  templateUrl: './encherdetails.component.html',
  styleUrl: './encherdetails.component.css'
})
export class EncherdetailsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute ,     private enchereService: EnchereService ,    private router: Router // Injecter Router
    ...
    ngOnInit(): void {
      this.route.paramMap.subscribe(params => {
        const idEnch = Number(params.get('id')); // Récupérez l'ID de l'enchère depuis les paramètres d'URL
        if (idEnch) {
